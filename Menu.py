...
def main():
    ...
    if selected == "Dashboard":
        ...
        st.write("Aplikasi ini memungkinkan Anda untuk melakukan kompresi dan dekompresi data teks (dokumen) serta data foto (gambar) secara mudah.")
        st.write("Berikut adalah cara menggunakan setiap fitur:")
        st.subheader("1. Kompresi dan Dekompresi Foto (Gambar)")
        st.write("Untuk melakukan kompresi gambar, unggah file gambar JPEG yang ingin Anda kompresi.")
        st.write("Pilih kualitas kompresi yang diinginkan menggunakan slider.")
        st.write("Klik tombol 'Kompres Foto' untuk memulai proses kompresi. Gambar yang telah dikompresi akan ditampilkan dan dapat diunduh.")
        st.write("Untuk melakukan dekompresi gambar, unggah file gambar JPEG yang telah dikompresi.")
        st.write("Klik tombol 'Dekompresi Foto' untuk mendapatkan gambar asli kembali.")
        st.subheader("2. Kompresi dan Dekompresi Dokumen (PDF)")
        st.write("Untuk melakukan kompresi dokumen PDF, unggah file dokumen PDF yang ingin Anda kompresi.")
        st.write("Pilih kualitas kompresi gambar dalam dokumen menggunakan slider.")
        st.write("Klik tombol 'Kompres Dokumen' untuk memulai proses kompresi. Dokumen yang telah dikompresi akan ditampilkan dan dapat diunduh.")
        st.write("Untuk melakukan dekompresi dokumen PDF, unggah file dokumen PDF yang telah dikompresi.")
        st.write("Klik tombol 'Dekompresi Dokumen' untuk mendapatkan dokumen asli kembali.")
